...
import { selectActiveBillsItem } from "@/store/features/data/dataSlice";
...
type TagsAndValuesType = {
    value: number,
    label: string,
}

export function getTagsAndValues(items: BillsDataItemType[]): TagsAndValuesType[] {
